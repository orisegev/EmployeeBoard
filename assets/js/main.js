...
document.getElementById('new-message-form').addEventListener('submit', function(event) {
	...
	.then(data => {
		if (data.success) {
			...
			deleteIcon.innerHTML = '<img title="מחק הודעה" alt="delete" src="./assets/images/delete-icon.png" width="20px" height="20px"></img>';  // Add a delete icon (can use any symbol or image)
